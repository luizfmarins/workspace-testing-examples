...
public interface NoteLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NoteLocalServiceUtil} to access the note local service. Add custom service methods to {@link com.liferay.notes.service.impl.NoteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Note fetchNoteByUuidAndGroupId(java.lang.String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Note getNoteByUuidAndGroupId(java.lang.String uuid, long groupId)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Note> getNotesByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
