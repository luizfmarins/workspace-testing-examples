...
package com.liferay.notes.service.base;
...
import com.liferay.notes.service.NoteLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.notes.service.impl.NoteLocalServiceImpl}.
 * </p>
 *
...
public abstract class NoteLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements NoteLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.notes.service.NoteLocalServiceUtil} to access the note local service.
	 */
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<Note>() {
				@Override
	...
	public List<Note> getNotesByUuidAndCompanyId(String uuid, long companyId,
		...
		return notePersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	 ...
	 */
	public NoteLocalService getNoteLocalService() {
	 ...
	 */
	public void setNoteLocalService(NoteLocalService noteLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.notes.model.Note",
			noteLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.notes.model.Note");
	}
	...
	@BeanReference(type = NoteLocalService.class)
